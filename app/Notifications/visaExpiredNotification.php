...
class visaExpiredNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        ->line('Wellcome almuayed visa ')
        ->line('Visa Has Been Expired ')
        ->action('Data "', url('www.almuayed.com'))
        ->line('T');
        
        // $this->data الاوبجكت دا فيهو كل الداتا بتاعت الفيزا المنتهية مفروض بس ترسلو في ال blade  و كان الله
