...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">التأشيرات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    معاينة طباعة التأشيرة</span>
            </div>
        </div>
                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">فاتورة التأشيرة</h1>
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                <label class="tx-gray-600">معلومات التأشيرة</label>
                                <p class="invoice-info-row"><span>رقم التأشيرة</span>
                                    <span>{{ $invoices->invoice_number }}</span></p>
                                <p class="invoice-info-row"><span>تاريخ الاصدار</span>
                                    <span>{{ $invoices->invoice_Date }}</span></p>
                                <p class="invoice-info-row"><span>تاريخ الانتهاء</span>
