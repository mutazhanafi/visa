...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">التأشرات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    تعديل تأشيرة</span>
            </div>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ url('invoices/update') }}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="inputName" class="control-label">رقم التأشيرة</label>
                                <input type="hidden" name="invoice_id" value="{{ $invoices->id }}">
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                    title="يرجي ادخال رقم التأشيرة" value="{{ $invoices->invoice_number }}" required>
                            </div>


                            <div class="col">
                                <label for="inputName" class="control-label"> الاسم</label>
                                <input type="hidden" name="invoice_name" value="{{ $invoices->invoice_name }}">
                                <input type="text" class="form-control" id="inputName" name="invoice_name"
                                    title="يرجي ادخال رقم التأشيرة" value="{{ $invoices->invoice_name }}" required>
                            </div>
