...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">نظام التأشيرات</li>
            <li class="slide">
            ...
            @can('الفواتير')
                <li class="side-item side-item-category">التأشيرات</li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        </svg><span class="side-menu__label">التأشيرات</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">

                        @can('قائمة الفواتير')

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices')) }}">قائمة التأشيرات</a></li>

                        @endcan

                        @can('الفواتير المدفوعة')

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Paid')) }}">التأشيرات المدفوعة</a>
                        ...
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_UnPaid')) }}">التأشيرات
                                    الغيرمدفوعة</a>
                            </li>
                        @endcan

                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Partial')) }}">التأشيرات المدفوعة
                                    جزئيا</a>
                            </li>
                        @endcan

                        @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Archive')) }}">ارشيف التأشيرات</a></li>
                        @endcan
                    </ul>
                </li>
            @endcan
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'invoices_report')) }}">تقارير التأشيرات</a>
                            </li>
                        @endcan

                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'customers_report')) }}">تقارير الخدمات </a>
                            </li>
                        @endcan
                    </ul>
                </li>
